...
- 原生 JVM 协议驱动：已实现 Modbus TCP/RTU、三菱 MC 3E/4E/A1E、OMRON FINS/TCP、Siemens S7 和 OPC UA 的读写、诊断与重连。
...
- Modbus TCP/RTU、三菱 MC 3E/4E/A1E、OMRON FINS/TCP、Siemens S7 和 OPC UA 采集与控制
- 实时值、历史采样、设备统计和采集调度
...
- 指标、仪表盘、进度条、状态灯、储罐、阀门、电机、流动管线、报警牌、时钟、表格、SVG 柱状/折线/饼图、文本、图片、iframe、装饰、容器和元组等组件
