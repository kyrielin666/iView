...
class DashboardDocumentValidator(private val modelById: (Long) -> DataModel) {
    fun validate(document: DashboardDocument, defaultModelId: Long? = null): DashboardDocument {
        ...
        val supported = setOf("chart", "table", "carousel_table", "video", "map", "metric", "gauge", "progress", "status", "clock", "text", "image", "decoration", "container", "tuple", "iframe", "tank", "valve", "motor", "pipe", "alarm")
